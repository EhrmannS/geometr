...
Interoperable data is data that has a common arrangement and that uses terms from the same <a href="http://www-ksl.stanford.edu/kst/what-is-an-ontology.html" target="_blank">ontology</a>.
...
Moreover, also the list of points is treated as a seperate, third attribute table, for attributes that only the points, but not the features (groups of points) have.
