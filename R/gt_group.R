#' Group the vertices of geometries
#'
#' \code{gt_group} assigns the vertices of a \code{geom} into new groups.
#' @param geom [\code{geom}]\cr object of class \code{\link{geom}} and type
#'   \code{point}.
#' @param index [\code{integerish(.)}]\cr a vector with group values for all
#'   vertices.
#' @param distance [\code{numeric(1)}]\cr specific distance of two vertices
#'   below which they will be included in the same cluster.
...
#'   them.
#' @return \code{geom} with (re)grouped coordinates.
