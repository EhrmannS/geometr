...
test_that("output is valid geometry", {
  ...
  output <- gt_translate(geom = input)
...
test_that("Error if arguments have wrong value", {
  ...
  expect_error(gt_translate(geom = "bla"))
  expect_error(gt_translate(geom = input, x = "bla"))
  expect_error(gt_translate(geom = input, y = "bla"))
  expect_error(gt_translate(geom = input, fid = "bla"))
  expect_error(gt_translate(geom = notinput))
})